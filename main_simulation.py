...
import os
path = r"C:\Users\yashm\AppData\Local\Microsoft\Windows\INetCache\IE\A05J2ZSI\cases[1].csv"
for n in range(35,36):
    summary, prosecution_proof, defense_proof, facts, w1, w2, final, case_id = func(path, n)
    class SupervisorAgent:
        def __init__(self, agents, system_prompt, model="llama3",):
        ...
        def respond(self, msg):
            ...
            answer = response.json().get("response", "[Error: No response received]").strip()
